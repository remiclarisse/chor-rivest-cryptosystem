...
Bien sûr, si en entrée de l'algorithme~\ref{algoAttaqueGoldreichsimplifiee}, le $t$ donné est $u \mbf t^{p^{jr}} -v$, il retourne le conjugué $\mbf g^{p^{jr}}$ du $\mbf g$ d'origine et l'entier $\mbf d - \log_{\mbf g^{p^{jr}}}(u)$.

...
Pour fixer les idées, nous donnerons en \verb|sage| les commandes utilisées pour effectuer les différents calculs. Il est cependant nécessaire de déclarer les variables \verb|p| et \verb|k|:
\begin{verbatim}
sage: p = 17 # peu importe les valeurs, il faut juste des nombres premiers

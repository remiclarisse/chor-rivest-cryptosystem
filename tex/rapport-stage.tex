...
Du 15 mai au 31 août 2017, j'ai intégré en tant que stagiaire l'équipe GRACE de Inria Saclay - Île-de-France. Sous la supervision de Daniel Augot, responsable de l'équipe, et Luca De Feo, j'ai étudié le cryptosystème \cite{chorRivest1988} présenté par Benny Chor et Ronald Rivest en 1984, ainsi que l'algorithme \cite{joux2013} qu'Antoine Joux à conçu en 2013 pour le calcul de logarithme discret dans un corps fini de petite caractéristique. Pour des raisons de limite temporelle, je n'ai pas vu l'algorithme quasi-polynomial \cite{barbulescu2013}, qui pourrait \textit{peut-être} mieux répondre à la problématique que nous nous posons.

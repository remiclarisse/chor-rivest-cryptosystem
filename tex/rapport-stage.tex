...
\subsubsection{Détail de la descente}\label{ss-sec:descente}
...
Remarquons que les facteurs de cette décomposition ne sont pas nécessairement unitaires, ni irréductible, et qu'ils peuvent avoir un degré plus petit que le facteur correspondant.
\end{theo}
